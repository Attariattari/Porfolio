          ...
          <div className="space-y-4 relative z-10">
            {fields.map((field, index) => {
              ...
              return (
                <div 
                  key={field.id}
                  className="group flex items-center gap-4 p-4 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-accent/30 transition-all"
                >
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <input
                      ...
                      className="w-full bg-transparent border-none p-0 text-sm font-medium focus:ring-0 placeholder:text-white/10 text-white"
                    />
                  </div>
            ...
            {fields.length < 5 && availablePlatforms.length > 0 && (
              <div className="pt-6">
                <p className="text-[10px] font-black uppercase tracking-widest text-white/30 mb-4 px-2">Add New Platform</p>
                  ...
                  {availablePlatforms.map(platform => {
                    ...
                    return (
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 hover:border-accent/40 hover:bg-accent/5 text-xs font-bold transition-all group"
                      >
