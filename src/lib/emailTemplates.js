        ...
        <table class="main" align="center">
            ...
            <tr>
                <td class="footer">
                    ...
                    <p style="margin-top: 24px;">You are receiving this because you subscribed to updates at <a href="${SITE_URL}" style="color: ${BRAND_ACCENT}; text-decoration: none;">www.muhyotech.com</a></p>
                    ${unsubscribeEmail ? `
