...
export const Mernstackfour = {
  ...
  Visit:"Cuts",
  details:
    "Cuts Clothing is a company which provide user online shopping",
};
...
export const Mernstackeleven = {
  ...
  Visit:"Silve",
  details:
    "Introducing the new Silve Roak. A digital platform that is as timeless as the iconic wine brand—celebrating rich tradition, family values, and innovative culture.",
};
