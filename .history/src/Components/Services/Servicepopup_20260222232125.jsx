    ...
    <div className={`Serviceall ${scrollDisabled ? "scroll-disabled" : ""}`}>
      {info && (
        <div className="Servicepopup-overlay" onClick={closePopup}>
          <div
            className="Servicepopup-content shadow-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header Section */}
            <div className="Servicepopup-header">
              <div className="icon-wrapper">
                <div className="main-icon text-5xl">{info.icons}</div>
              </div>
            ...
            <div className="Servicepopup-body custom-scrollbar">
              {/* Description */}
              <div className="description-section">{info.description}</div>
      ...
      {selectedNews && (
        <div className="Newspopup-overlay font-serif" onClick={closePopup}>
          <div
            className="Newspopup-content shadow-2xl custom-scrollbar"
            onClick={(e) => e.stopPropagation()}
          >
            ...
            <div className="news-body p-6">
              ...
              <div className="news-text-content">
                  ...
                  return (
                    <section key={key} className="story-section mb-12">
                      ...
                      {chapters.map((chapter, index) => (
                        <div
                          key={index}
                          className="chapter-box mb-8 text-center max-w-3xl mx-auto"
                        >
                          <h3 className="text-2xl font-serif mb-3 text-orange-500 italic">
                            {chapter.title}
                          </h3>
                ...
                <section className="story-conclusion mt-16 text-center">
                  <h2 className="text-3xl font-serif mb-6 italic text-orange-600">
                    The Takeaway
                  </h2>
